...
@connect(({ component, loading }) => ({
  component,
  submitting: loading.effects['component/fetch'],
...
export default class Component extends PureComponent {
  ...
  handleRefresh = () => {
    const { dispatch } = this.props;
    dispatch({ type: 'component/fetch', payload: {} });
  ...
  handleEdit = (_id, fields) => {
    this.props.dispatch({
      type: _id > 0 ? 'component/update' : 'component/add',
      payload: {
        id: _id,
        name: fields.name,
      },
  ...
  handleDeleteComponent = (record, e) => {
    e.preventDefault();
      ...
      },
      {
        ...
        render: (text, record) => (
          <Fragment>
            ...
            <a href="#" onClick={e => this.handleDeleteComponent(record, e)}>删除</a>
          </Fragment>
        ),
      },
    ];
